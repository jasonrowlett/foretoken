    ...
    <div className="bg-gray-950 min-h-screen pt-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="mb-12 text-center">
          <h1 className="font-notable text-5xl text-white mb-4">PRIVACY POLICY</h1>
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          <div className="bg-gray-900/50 border border-purple-400/20 rounded-lg p-8 space-y-6 text-gray-300">
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">3. Cookies and Analytics</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">5. Third-Party APIs</h2>
            <p>
            ...
            <p>
              Contact us at <a href="mailto:jason@foretoken.co" className="text-purple-400 hover:text-purple-300">jason@foretoken.co</a> for any such requests.
            </p>
